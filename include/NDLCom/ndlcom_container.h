...
namespace NDLCom
{
     ...
     * - NDLCom -- of course, the interface to manage all individual connections.
     ...
     * NDLCom::NDLCom, which then all are capable of sending and receiving
     ...
     * - The raw-traffic of each interface is shown in a separate window. This is
     *   not nice and not in the way it was handled before. But I didn't run into
     *   a nicer solution, and it works this way.
     * 
     * FIXME:
     ...
     * 
     * This text is basically the used commit-message for the initial commit. for a
